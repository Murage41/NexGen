...
export const addPayrollDeduction = (runId: number, lineId: number, data: any, operationKey?: string) =>
  financialPost(`/payroll/runs/${runId}/lines/${lineId}/deductions`, data, operationKey);
...
export const reversePayrollPayment = (id: number, reason: string) =>
  financialPost(`/payroll/payments/${id}/reverse`, { reason });
...
export const addShiftExpense = (shiftId: number, data: any, operationKey?: string) =>
  api.post(`/shifts/${shiftId}/expenses`, data, operationConfig(operationKey));
...
export const addShiftCredit = (shiftId: number, data: any, operationKey?: string) =>
  api.post(`/shifts/${shiftId}/credits`, data, operationConfig(operationKey));
